...
import 'package:farmers_market_web/models/category.dart';
import 'package:farmers_market_web/models/entities/commerce_image.dart';
import 'package:farmers_market_web/models/entities/exceptions.dart';
import 'package:farmers_market_web/models/entities/product_entity.dart';
import 'package:farmers_market_web/models/entity.dart';
import 'package:farmers_market_web/models/hashtag.dart';
import 'package:farmers_market_web/models/product_attribute.dart';
    ...
    if (entity is ProductEntity) {
      ...
      if (entity.categories.isNotEmpty) {
        entity.categories.forEach((category) =>
            categories.add(ProductCategory(category.id, name: category.title)));
      }
