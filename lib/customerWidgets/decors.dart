...
class Decors extends StatefulWidget {
  int colorVal;
  Decors(this.colorVal);
  _DecorsState createState() => _DecorsState();
}

class _DecorsState extends State<Decors> with SingleTickerProviderStateMixin {
