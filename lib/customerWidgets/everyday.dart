...
class EverydayFavourites extends StatefulWidget {
  int colorVal;
  EverydayFavourites(this.colorVal);
  _EverydayFavouritesState createState() => _EverydayFavouritesState();
}

class _EverydayFavouritesState extends State<EverydayFavourites>
